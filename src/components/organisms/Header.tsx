      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        {isMenuOpen && (
          <nav className="md:hidden absolute top-full left-0 w-full bg-darkBackground/90 backdrop-blur-md p-4 flex flex-col items-center space-y-4 shadow-lg">
            <a href="#experiencia" className="flex items-center space-x-2 py-3 px-4 rounded-full bg-gray-800 text-current hover:text-accent transition-colors w-1/2 justify-center">
              <FaBriefcase /> Experiencia
            </a>
            <a href="#certificados" className="flex items-center space-x-2 py-3 px-4 rounded-full bg-gray-800 text-current hover:text-accent transition-colors w-1/2 justify-center">
              <FaCode /> Certificados
            </a>
            <a href="#proyectos" className="flex items-center space-x-2 py-3 px-4 rounded-full bg-gray-800 text-current hover:text-accent transition-colors w-1/2 justify-center">
              <FaCode /> Proyectos
            </a>
            <a href="#sobre-mi" className="flex items-center space-x-2 py-3 px-4 rounded-full bg-gray-800 text-current hover:text-accent transition-colors w-1/2 justify-center">
              <FaUser /> Sobre mí
            </a>
            <a href="#contacto" className="flex items-center space-x-2 py-3 px-4 rounded-full bg-gray-800 text-current hover:text-accent transition-colors w-1/2 justify-center">
